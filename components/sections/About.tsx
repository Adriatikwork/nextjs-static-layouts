    ...
    <div className="min-h-screen bg-[#f5f1ed]">
      ...
      <section className="relative pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-sm tracking-[0.3em] uppercase text-[#068c8c] mb-6 font-light">
              {t.about.pageHeading}
            </p>
            <h1
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#068c8c]/20 rounded-full blur-2xl" />
              </div>
              {/* Floating Badge */}
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-white px-8 py-4 rounded-full shadow-xl border border-gray-100">
                <p
                  className="text-sm text-[#068c8c] font-normal tracking-wide"
                  style={{ fontFamily: 'Playfair Display, serif' }}
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#068c8c]/10 flex items-center justify-center group-hover:bg-[#068c8c] transition-colors duration-500">
                  <item.icon className="w-8 h-8 text-[#068c8c] group-hover:text-white transition-colors duration-500" />
                </div>
                <h3 
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-[#068c8c] text-white">
