export const content = {
      ...
      items: [
        {
          ...
          description: "Ogni persona è unica e merita un'attenzione personalizzata. Ascolto le esigenze di ogni paziente per offrire il trattamento più adatto.",
        },
        {
          title: "Precisione Medica",
          description: "Utilizzo protocolli clinici rigorosi e tecnologie avanzate per garantire risultati sicuri ed efficaci in ogni intervento.",
        },
        {
          title: "Risultati Naturali",
          description: "Il mio obiettivo è valorizzare la bellezza naturale di ogni persona, evitando eccessi e mantenendo l'armonia del viso.",
        },
        {
          title: "Sicurezza ed Etica",
          description: "La sicurezza del paziente è la priorità assoluta. Opero secondo i più alti standard etici e professionali della medicina.",
        },
      ],
    },
    gallery: {
  ...
  en: {
    ...
    hero: {
      ...
      description: "A personalized journey of health and beauty, based on your needs",
...
export type Content = typeof content.it
